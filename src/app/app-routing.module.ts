...
import { RegionMasterEntryComponent } from './Documents/region-master-entry/region-master-entry.component';
import { shopmasterComponent }  from './Documents/shop-master/shop-master.component';
...
const routes: Routes = [
  ...
  { path: 'RegionMasterEntry', component:RegionMasterEntryComponent, canActivate: [AuthGuard]},
  {path: 'shopmaster',component:shopmasterComponent,canActivate:[AuthGuard]},
  //{ path: 'DistrictMasterEntry', component:, canActivate: [AuthGuard]},
  {path: 'DistrictMasterEntry', component:DistrictMasterEntryComponent, canActivate: [AuthGuard]},
];
