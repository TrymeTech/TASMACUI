...
export class MenubarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.items = [
      ...
      {
        label: 'Masters', icon: 'pi pi-fw pi-user-edit', visible: showMenu,
        items: [
           
          {
            label: 'Region Office Master', routerLink: '/RegionMasterEntry'
          },
          {
            label: 'District Master', routerLink: '/DistrictMasterEntry'
          },
          {
            label: 'Shop Master', routerLink: '/shopmaster'
          },
        ]
      }
